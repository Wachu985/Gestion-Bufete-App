...
class AddContrato extends StatefulWidget {
  const AddContrato({super.key});

  @override
  State<AddContrato> createState() => _AddContratoState();
}
...
class _AddContratoState extends State<AddContrato> {
        ...
        children: [
          ...
          Hero(
            ...
            child: ElevatedButton(
              onPressed: () => _guardarValores(mes, context, contratoBloc),
              style: ButtonStyle(
  ...
  _guardarValores(
    ...
    contratoBloc.agregarContrato(newContrato);
